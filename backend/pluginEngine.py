...
async def on_init_plugin(sid, kwargs):
    ...
    pid = kwargs['id']
    env = kwargs.get('env', 'conda create -n python2 python=2.7 anaconda || source activate python2 || activate python2 && pip install six requests gevent websocket-client && python')
