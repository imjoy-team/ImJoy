...
(function(){
    ...
    site.onRemoteUpdate(function(){
        ...
        if(api.export) { console.error("WARNING: overwriting function 'export'.")}
        if(api.onload) { console.error("WARNING: overwriting function 'onload'.")}
        if(api.dispose) { console.error("WARNING: overwriting function 'dispose'.")}
