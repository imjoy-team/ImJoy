...
!(function(a) {
  ...
  var a = { noMore: !1, useDirtyCheck: !1 },
    b = [],
    c = [],
    d = [],
    e = !1;
  try {
    e = Object.defineProperty && Object.defineProperty({}, "x", {});
  } catch (a) {}
  var f = function(a) {
      var b = {};
    ...
    j = function(a, b) {
      ...
      if ("string" != typeof a && "string" != typeof b) {
        if (h(a) && b)
          ...
          for (var e in a)
            a.hasOwnProperty(e) && b && void 0 === b[e] && c.push(e);
        if (h(b) && a)
          for (var f = 0; f < b.length; f++) void 0 === a[f] && d.push(f);
        else
          for (var f in b)
            b.hasOwnProperty(f) && a && void 0 === a[f] && d.push(f);
      }
        ...
        try {
          ...
          try {
            Object.prototype.__defineGetter__.call(a, b, c),
              Object.prototype.__defineSetter__.call(a, b, function(a) {
                d.call(this, a, !0);
              });
          } catch (c) {
            n(a, b, d);
    ...
    n = function(a, b, d) {
      c[c.length] = { prop: b, object: a, orig: k(a[b]), callback: d };
    },
    o = function() {
      f(arguments[1])
    ...
    p = function(a, b, c, d) {
      if ("string" != typeof a && (a instanceof Object || h(a))) {
        if (h(a)) {
          if ((D(a, "__watchall__", b, c), void 0 === c || c > 0))
            for (var f = 0; f < a.length; f++) p(a[f], b, c, d);
        } else {
          var f,
            g = [];
          for (f in a)
            "$val" == f ||
              (!e && "watchers" === f) ||
              (Object.prototype.hasOwnProperty.call(a, f) && g.push(f));
          q(a, g, b, c, d);
        }
    ...
    r = function(a, b, c, d, e) {
      "string" != typeof a &&
        (a instanceof Object || h(a)) &&
        (f(a[b]) ||
          (null != a[b] &&
            (void 0 === d || d > 0) &&
            p(a[b], c, void 0 !== d ? d - 1 : d),
          D(a, b, c, d),
      ...
      if (!(a instanceof String) && (a instanceof Object || h(a)))
        if (h(a)) {
          ...
          var e = function(a) {
            ...
            for (var d in a)
              a.hasOwnProperty(d) &&
                (a[d] instanceof Object ? e(a[d]) : c.push(d));
            u(a, c, b);
          };
          e(a);
        }
    ...
    D = function(b, c, d, e) {
      ...
      b.watchers ||
        (m(b, "watchers", {}),
        g &&
          H(b, function(a, d, f, g) {
            if ((N(b, a, d, f, g), 0 !== e && f && (i(f) || h(f)))) {
              var j,
                k,
                l,
                m,
                n = b.watchers[c];
              for (
                (m = b.watchers.__watchall__) && (n = n ? n.concat(m) : m),
                  l = n ? n.length : 0,
                  j = 0;
                j < l;
                j++
              )
                if ("splice" !== d) p(f, n[j], void 0 === e ? e : e - 1);
                else
                  for (k = 0; k < f.length; k++)
                    p(f[k], n[j], void 0 === e ? e : e - 1);
            }
          })),
        b.watchers[c] || ((b.watchers[c] = []), g || (f = !0));
      for (var j = 0; j < b.watchers[c].length; j++)
        if (b.watchers[c][j] === d) return;
      if ((b.watchers[c].push(d), f)) {
        var k = b[c],
          o = function() {
            return k;
          },
          q = function(d, f) {
            ...
            if (
              ((k = d),
              0 !== e && b[c] && (i(b[c]) || h(b[c])) && !b[c].watchers)
            ) {
              var j,
                l = b.watchers[c].length;
              for (j = 0; j < l; j++)
                p(b[c], b.watchers[c][j], void 0 === e ? e : e - 1);
            }
            return K(b, c)
              ? void L(b, c)
              : void (
                  a.noMore ||
                  (g !== d &&
                    (f ? N(b, c, "set", d, g) : E(b, c, "set", d, g),
                    (a.noMore = !1)))
                );
          };
        a.useDirtyCheck ? n(b, c, q) : l(b, c, o, q);
      }
    },
    E = function(a, b, c, d, e) {
      if (void 0 !== b) {
        var f,
          g,
          h = a.watchers[b];
        (g = a.watchers.__watchall__) && (h = h ? h.concat(g) : g),
          (f = h ? h.length : 0);
    ...
    G = function(a, b, c, d) {
      m(a, c, function() {
        ...
        if ("splice" === c) {
          var j = arguments[0],
            k = j + arguments[1];
          for (h = a.slice(j, k), g = [], f = 2; f < arguments.length; f++)
            g[f - 2] = arguments[f];
          e = j;
        } else g = arguments.length > 0 ? arguments[0] : void 0;
        return (
          (i = b.apply(a, arguments)),
          "slice" !== c &&
            ("pop" === c
              ? ((h = i), (e = a.length))
              : "push" === c
    ...
    H = function(a, b) {
      if (f(b) && a && !(a instanceof String) && h(a))
        for (var d, c = F.length; c--; ) (d = F[c]), G(a, a[d], d, b);
    },
    I = function(a, b, c) {
      if (b) {
        if (a.watchers[b])
          if (void 0 === c) delete a.watchers[b];
            ...
            for (var d = 0; d < a.watchers[b].length; d++) {
    ...
    K = function(a, b) {
      return (
        a.watchers &&
        (a.watchers.__wjs_suspend__ || a.watchers["__wjs_suspend__" + b])
      );
    },
    L = function(a, b) {
      z(function() {
    ...
    N = function(a, b, c, e, f) {
      (d[d.length] = { obj: a, prop: b, mode: c, newval: e, oldval: f }),
    ...
    O = function() {
      ...
      for (var b = 0; b < d.length; b++)
        (a = d[b]), E(a.obj, a.prop, a.mode, a.newval, a.oldval);
      a && ((d = []), (a = null));
    },
    P = function() {
      for (var a = 0; a < b.length; a++) {
        ...
        if ("$$watchlengthsubjectroot" === d.prop) {
          var e = j(d.obj, d.actual);
          (e.added.length || e.removed.length) &&
            (e.added.length && q(d.obj, e.added, d.watcher, d.level - 1, !0),
            d.watcher.call(d.obj, "root", "differentattr", e, d.actual)),
            (d.actual = k(d.obj));
        } else {
          var e = j(d.obj[d.prop], d.actual);
          if (e.added.length || e.removed.length) {
            if (e.added.length)
              for (var f = 0; f < d.obj.watchers[d.prop].length; f++)
                q(
                  d.obj[d.prop],
                  e.added,
                  d.obj.watchers[d.prop][f],
                  d.level - 1,
                  !0
                );
            E(d.obj, d.prop, "differentattr", e, d.actual);
          }
          d.actual = k(d.obj[d.prop]);
        }
      }
      var g, h;
      if (c.length > 0)
        for (var a = 0; a < c.length; a++)
          (g = c[a]),
            (h = g.object[g.prop]),
            Q(g.orig, h) || ((g.orig = k(h)), g.callback(h));
    },
    Q = function(a, b) {
      var c,
        d = !0;
    ...
    R = function(a, c, d, e) {
      var f;
      (f = k("$$watchlengthsubjectroot" === c ? a : a[c])),
        b.push({ obj: a, prop: c, actual: f, watcher: d, level: e });
    },
    S = function(a, c, d) {
      for (var e = 0; e < b.length; e++) {
        var f = b[e];
        f.obj == a &&
          ((c && f.prop != c) || (d && f.watcher != d) || b.splice(e--, 1));
      }
    },
    T = function(a, b) {
