          ...
          <div class="md-toolbar-section-end">
            <md-menu md-size="medium" v-if="screenWidth<600">
              ...
              <md-menu-content>
                ...
                <md-menu-item class="md-primary md-button menu-button" href="/docs/index.html#/overview">Docs</md-menu-item>
            ...
            &nbsp;
            <md-button href="/docs/index.html#/overview" class="md-accent" v-if="screenWidth>=600">
