    ...
    <div class="md-layout md-alignment-center-center">
      ...
      >
        <md-tooltip
          ...
          a Creative Commons Attribution 4.0 International license.</md-tooltip
        >
        <img id="cc-by-img" src="static/img/by.svg" alt="CC BY 4.0" />
      </md-button>
      <md-button class="footer-button" @click="$router.push('/about')"
        >About ImJoy.io</md-button
      >
    </div>
    <div class="md-layout md-alignment-center-center">
      <md-button
      ...
      <md-button
        class="footer-button"
        target="_blank"
        href="https://sites.google.com/site/imagingandmodeling/"
        >Powered by Imaging and Modeling Unit</md-button
      >
...
.holds-the-iframe {
  background: url(/static/img/ImJoy.io-icon-circle-animation.svg) center center
    no-repeat;
}
