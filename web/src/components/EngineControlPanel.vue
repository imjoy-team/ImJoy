    ...
    >
      ...
      <md-dialog-content>
        ...
        <div v-if="!is_mobile_or_tablet">
          ...
          >
          <p v-if="url_type === 'remote'">You may want to use <a href="https://telebit.cloud/" target="_blank">Telebit</a> or <a href="https://ngrok.com/" target="_blank">ngrok</a> to make your plugin engine available outside your network.</p>
