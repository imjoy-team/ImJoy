      ...
      <md-toolbar class="md-transparent md-dense" md-elevation="0">
        <div class="md-toolbar-row" flex>
            <div class="md-toolbar-section-end" >
              <md-button  href="https://github.com/oeway/ImJoy" target="_blank"><md-icon md-src="static/img/github.svg" class="md-size-1x svg-icon"></md-icon>source code</md-button>
